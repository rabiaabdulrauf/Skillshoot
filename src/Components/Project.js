            ...
            <div className="bg-gradient-to-t from-white to-purple-200 py-10 px-6">
              <div className="flex flex-col-reverse lg:flex-row justify-between items-center gap-10">
                <div className="w-full lg:w-1/2 text-left pl-8">
                  <h1 className="font-bold text-3xl sm:text-4xl md:text-5xl text-black">Project Manager</h1>
                  <p className="pt-6  text-black text-base sm:text-lg">
                    Your career in project Management starts here.<br />
                  ...
                  <div className="flex flex-wrap gap-6 pt-6">
                    ...
                    <div className="flex flex-col text-black">
                      <p className="font-bold text-lg">22.6</p>
                ...
                <div className="w-full lg:w-1/2 flex justify-center ">
                  <img src={pm} alt="Full Stack" className="w-full max-w-[450px] h-auto rounded-lg" />
                </div>
              </div>
            </div>
    </div>

...
const Bar = () => {
  ...
  return (
    <div style={{ backgroundImage: `url(${bg})` }} className='h-auto w-full bg-no-repeat bg-cover pt-4 pb-10'>
      <nav className="bg-white lg:mx-20 rounded-2xl">
          ...
          <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              <div className="flex shrink-0 items-center">
                <img className="h-8 w-auto" src={logo} alt="SkillShoot Logo" />
              ...
              <div className="hidden sm:flex flex-wrap items-center gap-3 md:pl-24 lg:pl-6">
                <div className="flex space-x-3 lg:gap-4 items-center">
                  <Link to="/" className="rounded-md lg:px-3 md:px-1 py-2 text-sm font-medium hover:text-purple-500">Home</Link>
        ...
        {isOpen && (
          <div className="sm:hidden" id="mobile-menu">
            <div className="space-y-1 px-2 pt-2 pb-3">
              <Link to="/" className="block rounded-md bg-purple-500 px-3 py-2 text-base font-medium text-white">Home</Link>
              ...
              <a href="#course" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-purple-500 hover:text-white">Courses</a>
      ...
      <div className="button flex justify-center mt-4">
        <button className='border px-12 py-4 bg-purple-500 rounded-3xl text-white hover:bg-purple-600'>ENROLL NOW</button>
      </div>
    </div>
  );
};
